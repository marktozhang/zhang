...
#include "ui_floormanage.h"
#include"scdata.h"
floormanage::floormanage(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::floormanage)
{
    ui->setupUi(this);
    this->setWindowTitle("楼号管理");
...
void floormanage::showthis()
{
    this->show();
}

void floormanage::setQSS(QString  arg1)
{
    if(arg1==QString("墨绿"))
        {
       this->setStyleSheet("\
...
void floormanage::on_pushButton_clicked()
{
    this->hide();
}
...
void floormanage::on_delete_2_clicked()
{
...
void floormanage::on_pushButton_2_clicked()
{
    QString xxxx=ui->txt->text();
    ui->listWidget_2->addItem(xxxx);
}

void floormanage::on_pushButton_4_clicked()
{
    int num=ui->listWidget_2->count();
    int now=ui->listWidget_2->currentRow();
...
void floormanage::on_add_clicked()
{
...
void floormanage::on_xiugai_clicked()
{
    int num=ui->listWidget_2->count();
    int now=ui->listWidget_2->currentRow();
    QString  das=ui->txt->text();
