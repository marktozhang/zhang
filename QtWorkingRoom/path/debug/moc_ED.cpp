...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ED_t, stringdata) + ofs \
...
void ED::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ED *_t = static_cast<ED *>(_o);
        switch (_id) {
        case 0: _t->Btn_slot(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ED::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ED.data,
      qt_meta_data_ED,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ED.stringdata))
        return static_cast<void*>(const_cast< ED*>(this));
