...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Esp8266_t, stringdata) + ofs \
...
const QMetaObject Esp8266::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Esp8266.data,
      qt_meta_data_Esp8266,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Esp8266.stringdata))
        return static_cast<void*>(const_cast< Esp8266*>(this));
