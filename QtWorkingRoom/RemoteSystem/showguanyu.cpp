...
#include "ui_showguanyu.h"

showguanyu::showguanyu(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::showguanyu)
{
    ui->setupUi(this);
    this->setWindowTitle("关于");
}

showguanyu::~showguanyu()
{
    delete ui;
}

void showguanyu::showthis()
{
    this->show();
}

void showguanyu::setQSS(QString  arg1)
{
...
void showguanyu::on_pushButton_clicked()
{
    this->hide();
}
