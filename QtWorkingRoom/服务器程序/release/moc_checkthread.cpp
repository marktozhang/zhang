...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_checkthread_t, stringdata) + ofs \
...
const QMetaObject checkthread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_checkthread.data,
      qt_meta_data_checkthread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_checkthread.stringdata))
