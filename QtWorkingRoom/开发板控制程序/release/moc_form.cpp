...
QT_MOC_LITERAL(5, 60, 28)
    ...
    "Form\0send_show_mainwondow\0\0recv_showthis\0"
    "recv_show_isonline\0on_return_mainwindow_clicked"
};
...
void Form::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->send_show_mainwondow(); break;
        case 1: _t->recv_showthis(); break;
        case 2: _t->recv_show_isonline((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->on_return_mainwindow_clicked(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Form::send_show_mainwondow)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Form::send_show_mainwondow()
{
